...
export function leerExcelEstructura(filePath: string): { rows: FilaEstructura[]; headers: string[] } {
  ...
  NIVEL_INGLES: ['NIVEL Y CICLO INGLÉS','NIVEL Y CICLO INGLES','NIVEL INGLES','NIVEL/CICLO INGLES','NIVEL/CICLO INGLÉS'],
  CORREO: ['CORREO','CORREO INSTITUCIONAL','EMAIL','CORREOS']
};
